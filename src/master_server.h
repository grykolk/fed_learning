...
class master_server {
	...
	std::vector<seal::Ciphertext> biases;
...
public:
	...
	void aggregate_with_encryption(std::vector <seal::Ciphertext> Weight, std::vector <seal::Ciphertext> Biases, int Wsize , int Bsize);
	...
	std::vector<seal::Ciphertext>get_encryption_biases();
};
#endif // !1
